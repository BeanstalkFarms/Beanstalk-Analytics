...
import Sunrises from "../components/v1/Sunrises";
import FertQueue from "../components/v1/FertQueue";
    ...
    <Page rightHeader={rightHeader}>
      <div className={COL_ITEM}>
        <CallsModule
          title="Sun"
          slots={[
            ['Paused', 'paused', undefined, undefined, 'Whether or not Beanstalk is Paused.'],
            ['Season', 'season'],
